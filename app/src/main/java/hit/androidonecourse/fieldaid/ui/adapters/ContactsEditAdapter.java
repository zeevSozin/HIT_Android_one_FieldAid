...
import hit.androidonecourse.fieldaid.databinding.ContactListItemEditBinding;
...
public class ContactsEditAdapter extends ArrayAdapter<Contact> {
    ...
    public ContactsEditAdapter(@NonNull Context context, int resource, @NonNull List<Contact> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ContactListItemEditBinding binding = DataBindingUtil.inflate(layoutInflater, resourceLayoutId,parent,false);
